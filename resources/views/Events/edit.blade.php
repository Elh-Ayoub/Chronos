                ...
                <form action="{{route('events.update',  $event->id)}}" class="card card-primary" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control" maxlength="100" value="{{$event->title}}">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea id="description" name="description" class="form-control" maxlength="300">{{$event->description}}</textarea>
                        </div>
                        <div class="form-group d-flex justify-content-around">
                            <div class="form-group d-flex">
                                <label for="start" class="col-sm-4">Start date</label>
                                <input type="datetime-local" id="start" name="start" class="form-control" placeholder="start" value="{{date('Y-m-d\TH:i:s', strtotime($event->start))}}">
                            </div>
                            <div class="form-group d-flex">
                                <label for="end" class="col-sm-4">End date</label>
                                <input type="datetime-local" id="end" name="end" class="form-control" value="{{date('Y-m-d\TH:i:s', strtotime($event->end))}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="w-100 row justify-content-around flex-row">
                                <div>
                                    <input class="color-select invisible" type="radio" name="backgroundColor" id="blue-border" autocomplete="off" value="#0073b7" {{ ($event->backgroundColor === '#0073b7') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="backgroundColor" id="yellow" autocomplete="off" value="#f39c12" {{ ($event->backgroundColor === '#f39c12') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="backgroundColor" id="green" autocomplete="off" value="#00a65a" {{ ($event->backgroundColor === '#00a65a') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="backgroundColor" id="red" autocomplete="off" value="#f56954" {{ ($event->backgroundColor === '#f56954') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="backgroundColor" id="aqua" autocomplete="off" value="#00c0ef" {{ ($event->backgroundColor === '#00c0ef') ? "checked" : "" }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 row justify-content-around flex-row">
                                <div>
                                    <input class="color-select invisible" type="radio" name="borderColor" id="blue-border" autocomplete="off" value="#0073b7" {{ ($event->borderColor === '#0073b7') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="borderColor" id="yellow-border" autocomplete="off" value="#f39c12" {{ ($event->borderColor === '#f39c12') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="borderColor" id="green-border" autocomplete="off" value="#00a65a" {{ ($event->borderColor === '#00a65a') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="borderColor" id="red-border" autocomplete="off" value="#f56954" {{ ($event->borderColor === '#f56954') ? "checked" : "" }}>
                                ...
                                <div>
                                    <input class="color-select invisible" type="radio" name="borderColor" id="aqua-border" autocomplete="off" value="#00c0ef" {{ ($event->borderColor === '#00c0ef') ? "checked" : "" }}>
                        ...
                        <div class="form-group d-flex justify-content-around align-items-center">
                            <div class="form-group d-flex align-items-center col-4 mt-4">
                                ...
                                <select id="inputallDay" name="allDay" class="form-control custom-select">
                                    <option selected disabled>{{$event->allDay ? ($event->allDay) : ('false')}}</option>
                                    <option>true</option>
